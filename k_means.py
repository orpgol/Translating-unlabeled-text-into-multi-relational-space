...
class Word2Vec(object):
  ...
  def plot_k_means(self, centers):
    ...
    def plot(embeddings, labels, centers):
...
if __name__ == "__main__":
  ...
  with tf.Graph().as_default(), tf.Session() as session:
      ...
      model.saver.restore(session, os.path.join(opts.save_path, "model.ckpt-7552356"))
      #model.analogy(b'horizontal', b'vertical', b'black')
      centers, assignments = model.k_means()
